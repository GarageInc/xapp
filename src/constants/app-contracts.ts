...
const LP_ADDRESS = '0x74f4B6c7F7F518202231b58CE6e8736DF6B50A81'

const STAKING_REWARD_TOKEN = '0xB867C7a3e18deb63964AF56bF0770c20Fe4d80df'

export const useErc20Contract = (token?: string) => {
  return useContract<Erc20>(token, erc20Abi)
}

const useStakingLPContract = () => {
